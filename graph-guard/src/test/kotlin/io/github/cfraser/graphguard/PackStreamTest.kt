  ...
  init {
    ...
    context("unpack boolean") {
      withData(
        ...
        byteArrayOf(0xc2.toByte()).unpack { boolean() } to false,
      ) { (actual, expected) ->
        actual shouldBe expected
      }
    }
    ...
    context("unpack integer") {
      withData(
        ...
        ubyteArrayOf(0xcaU, 0x00U, 0x00U, 0x80U, 0x00U).toByteArray().unpack { integer() } to 32768,
        ...
        ubyteArrayOf(0xc8U, 0x80U).toByteArray().unpack { integer() } to -128,
        ubyteArrayOf(0xcaU, 0x00U, 0x00U, 0xffU, 0xffU).toByteArray().unpack { integer() } to 65535,
        ubyteArrayOf(0xc9U, 0x80U, 0x00U).toByteArray().unpack { integer() } to -32768,
    ...
    context("unpack list") {
      withData(
        ...
        ubyteArrayOf(0x93U, 0xc0U, 0x81U, 0x73U, 0x01U).toByteArray().unpack { list() } to
          listOf(null, "s", 1L),
        ubyteArrayOf(0x93U, 0x01U, 0xcaU, 0x00U, 0x00U, 0x80U, 0x00U, 0x00U).toByteArray().unpack {
          list()
        } to listOf(1L, 32768L, 0L),
        ubyteArrayOf(0x91U, 0xc1U, 0x40U, 0x09U, 0x1eU, 0xb8U, 0x51U, 0xebU, 0x85U, 0x1fU)
          .toByteArray()
        ...
        listOfSize(65536).let { list ->
          ubyteArrayOf(0xd6U, 0x00U, 0x01U, 0x00U, 0x00U, *list.map { it.toUByte() }.toUByteArray())
            .toByteArray()
            .unpack { list() } to list
        },
      ) { (actual, expected) ->
